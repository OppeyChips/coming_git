...
const vertex = /* glsl */ `
  ...
  void main() {
    ...
    float t = uTime * 0.5;
    mPos.x += sin(t * random.z + 6.28 * random.w) * mix(0.1, 1.0, random.x);
    mPos.y += sin(t * random.y + 6.28 * random.x) * mix(0.1, 1.0, random.w);
    mPos.z += sin(t * random.w + 6.28 * random.y) * mix(0.1, 1.0, random.z);
